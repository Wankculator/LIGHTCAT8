...
class InputValidatorPro {
    ...
    cleanup() {
        ...
        window.SafeEvents.cleanup();
            ...
            // RGB Protocol
            rgbInvoice: /^rgb:utxob:[a-zA-Z0-9]+$/,
    ...
    validateRGBInvoice(invoice) {
        ...
        if (!this.patterns.rgbInvoice.test(invoice)) {
            return { valid: false, error: 'Invalid RGB invoice format. Expected: rgb:utxob:...' };
        }
        ...
        return { valid: true, parts: { protocol: parts[0], type: parts[1], data: parts[2] } };
    }
