...
export class CollectibleManager {
    ...
    spawnSingleLightning() {
        ...
        // Random rotation
        lightning.rotation.y = gameRandom() * Math.PI * 2;
        lightning.rotation.z = gameRandom() * 0.5 - 0.25;
        
        // Scale
        lightning.scale.setScalar(0.5 + gameRandom() * 0.5);
        ...
        lightning.floatOffset = gameRandom() * Math.PI * 2;
